...
$html = '<h2 style="text-align:center"><font color="#FF0000">Reporte de Productos Registrados</font></h2>';
...
foreach ($productos as $valor) {
    ...
    $html .= '<td>' . ucwords($valor->descripcion) . '</td>';
    $html .= '<td>' . $valor->precio_compra . '</td>';
    $html .= '<td>' . $valor->precio_venta . '</td>';
    $html .= '<td>' . ucwords($valor->cantidad) . '</td>';
    $html .= '<td>' . ucwords($valor->fecha) . '</td></tr>';    
}
