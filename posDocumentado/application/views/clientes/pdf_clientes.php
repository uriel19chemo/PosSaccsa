...
$html = '<h2 style="text-align:center"><font color="#FF0000">Reporte de Clientes Registrados</font></h2>';
...
foreach ($clientes as $valor) {
    ...
    $html .= '<tr ' . $style . '><td>' . $valor->CODIGO_CLIENTE . '</td>';
    $html .= '<td>' . ucwords($valor->NOMBRE . ' ' . $valor->APELLIDOS) . '</td>';
    $html .= '<td>' . $valor->EMAIL . '</td>';
    $html .= '<td>' . $valor->TELEFONO . '</td>';
    $html .= '<td>' . ucwords($valor->RFC) . '</td>';
    $html .= '<td>' . ucwords($valor->FECHA_REGISTRO) . '</td></tr>';  
